...
) ENGINE = InnoDB  CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'WATER-消息-派送表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `water_msg_message`  (
  ...
  INDEX `IX_last_date`(`last_date`) USING BTREE
...
CREATE TABLE `water_msg_message_ex_stat`  (
  ...
  INDEX `IX_log_date`(`log_date`) USING BTREE
) ENGINE = InnoDB  CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'WATER-消息-统计表' ROW_FORMAT = DYNAMIC;
