...
CREATE TABLE IF NOT EXISTS `water_cfg_broker`  (
  ...
  `broker` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '' COMMENT '协调器',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'WATER-配置-消息协调器表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE IF NOT EXISTS `water_cfg_logger`  (
  ...
  INDEX `IX_tag`(`tag`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'WATER-配置-日志记录器表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'WATER-消息-订阅者表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB  CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'WATER-消息-主题表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB  CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'WATER-运维-服务器表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'WATER-注册-服务消费者表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE IF NOT EXISTS `water_tool_report`  (
  ...
  PRIMARY KEY (`row_id`) USING BTREE,
  INDEX `IX_tag`(`tag`) USING BTREE
) ENGINE = InnoDB  CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'WATER-工具-数据简报' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE IF NOT EXISTS `water_tool_synchronous`  (
  ...
  INDEX `IX_key`(`key`) USING BTREE,
  INDEX `IX_tag`(`tag`) USING BTREE
) ENGINE = InnoDB  CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'WATER-工具-同步配置表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB  CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = 'WATER-工具-数据版本存储表' ROW_FORMAT = DYNAMIC;
