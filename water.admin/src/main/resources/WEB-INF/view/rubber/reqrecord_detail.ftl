...
<main>
    <detail>
        <header>
            <table>
                <tr>
                    <td width="70px"><b>请求ID：</b></td>
                    <td><b>${log.request_id}（No.${log.log_id}）（<a onclick="history.back(-1)" class="t2">返回</a>，<a onclick="f1.submit()" class="t2">重试</a>，<a onclick="f2.submit()" class="t2">调试</a>）</b></td>
                </tr>
                <tr>
                    <td>请求时间：</td>
                ...
                <datagrid>
                    <table>
                        ...
                        <tr>
                            ...
                            <td >结果</td>
                            <td width="60px">处理时间</td>
                            <td width="110px">规则数</td>
                            <td width="60px">匹配数</td>
                            <td width="60px">规则关系</td>
                        </tr>
                        </thead>
                        <tbody>
                ...
                <datagrid>
                    <table>
                        ...
                        <tr>
                            ...
                            <td width="60px">评估分值</td>
                            <td width="60px">评估建议</td>
                        </tr>
                        </thead>
                        <tbody>
