...
<table id="excuteNode" style="margin-top: 10px;">
    ...
    <tr>
        ...
        <td>
            <select name="manager" id="manager" style="width:304px;">
                <#list actors as m>
    ...
    <tr>
        ...
        <td id="excuteTask">
            <div id="taskAll">
                ...
                <div class="taskAll">
                    <select name="nodeType" onchange="changeTaskType(this)">
        ...
        <td valign="bottom">
            <button style="margin: 0px; margin-bottom:5px;width: 50px;" class="edit" onclick="addTask()" >添加</button>
        </td>
    </tr>
</table>
...
<script>
    function addTask(index) {
        var htmm = '<div><select onchange="changeTaskType(this)"><option value="R">计算方案</option>'+
            '</select> <select class="task"><option value=""></option>';
