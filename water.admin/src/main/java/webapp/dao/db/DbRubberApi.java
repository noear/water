...
import webapp.models.water_rebber.SchemeModel;
import webapp.models.water_rebber.SchemeRuleModel;
import webapp.models.water_rebber.SchemeNodeDesignModel;
...
public class DbRubberApi {
    ...
    //获取模型tag
    public static List<ModelModel> getModelTags() throws SQLException {
    ...
    //获取模型tag
    public static List<ModelModel> getActorTags() throws SQLException {
    ...
    public static boolean containActorTag(List<ModelModel> list, String tag) {
        boolean flag = false;
    ...
    //获取计算方案标签列表
    public static List<SchemeModel> getSchemeTags() throws SQLException {
...
//    }
    ...
    //获取数据block的tag集合
    public static List<BlockModel> getBlockTags() throws SQLException {
        return db().table("rubber_block")
                .groupBy("tag")
                .select("tag,count(*) counts")
    ...
    //新增或修改数据块
    public static long setRubberBlock(Integer block_id, String tag, String name, String name_display, String related_db, String related_tb,
    ...
    public static List<BlockModel> getBlocksByTagOrNameArray(String tags) throws SQLException {
        ...
        return db().table("rubber_block").expre(tb ->{
            tb.where("1 != 1");
