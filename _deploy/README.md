...
| 镜像                      | 镜像端口    | 说明                 |
|-------------------------|-------|--------------------|
| noearorg/waterapi:2.9.3 | 9371  | 主接口服务              |
| noearorg/watersev:2.9.3       | 9372  | 批处理服务              |
| noearorg/wateradmin:2.9.3     | 9373  | 管理控制台              |
| noearorg/waterfaas:2.9.3      | 9374  | FaaS 即时接口服务        |
|                         |       |                    |
| noearorg/xwater:2.9.3         | 19371 | Water助理工具（仅在需要时启用） |
