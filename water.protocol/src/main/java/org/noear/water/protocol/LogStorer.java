...
public interface LogStorer {
    ...
    default void write(String logger, String trace_id, Level level, String tag, String summary, Object content, String from) throws Exception {
        write(logger, trace_id, level, tag, null, null, null, summary, content, from);
    }

    default void write(String logger, String trace_id, Level level, String tag, String tag1, String summary, Object content, String from) throws Exception {
