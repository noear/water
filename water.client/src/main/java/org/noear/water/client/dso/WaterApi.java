...
import org.noear.water.client.utils.HttpUtils;
...
public class WaterApi {
    ...
    public static String post(String path, Map<String,Object> data) throws Exception{
        String url = WaterConfig.water_api_url + path;
        return HttpUtils.http(url).data(data).post();
    }


    public static void postAsync(String path, Map<String,Object> data) throws Exception{
        String url = WaterConfig.water_api_url + path;
