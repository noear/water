...
public final class CronExpression implements Serializable, Cloneable {
    ...
    protected int storeExpressionVals(int pos, String s, int type)
        ...
        if (c == '*' || c == '/') {
            ...
            if(type == DAY_OF_MONTH && s.length() > i) {
                c = s.charAt(i);
                if(c == '-') {
                    CronValueSet vs = getValue(0, s, i+1);
            ...
            if (i >= s.length()) {
                ...
                c = s.charAt(i);
                if (c >= '0' && c <= '9') {
                    CronValueSet vs = getValue(val, s, i);
                    val = vs.value;
                    i = vs.pos;
                }
    ...
    protected int checkNext(int pos, String s, int val, int type)
        ...
        if (c == '-') {
            ...
            c = s.charAt(i);
            if (c >= '0' && c <= '9') {
                CronValueSet vs = getValue(v, s, i);
                end = vs.value;
                i = vs.pos;
            }
            if (i < s.length() && ((c = s.charAt(i)) == '/')) {
                ...
                c = s.charAt(i);
                if (c >= '0' && c <= '9') {
                    CronValueSet vs = getValue(v2, s, i);
                    int v3 = vs.value;
    ...
    protected CronValueSet getValue(int v, String s, int i) {
        char c = s.charAt(i);
        ...
        CronValueSet val = new CronValueSet();
