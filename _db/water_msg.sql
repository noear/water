/*
 ...
 Source Schema         : water_msg

 Target Server Type    : MySQL
 Target Server Version : 80020
 File Encoding         : 65001

 Date: 12/03/2021 15:45:48
*/
...
CREATE TABLE `water_msg_distribution`  (
  ...
  `msg_key` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL,
  `subscriber_id` int NOT NULL,
  `subscriber_key` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL,
  `alarm_mobile` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL,
  `alarm_sign` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL,
  `receive_url` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
  `receive_way` int NOT NULL DEFAULT 0 COMMENT '接收方式（0HTTP异步等待；1HTTP同步等待；2HTTP异步不等待）',
  `receive_check` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT 'OK',
  `receive_key` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
...
) ENGINE = InnoDB AUTO_INCREMENT = 723531 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = 'WATER-消息-派送表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `water_msg_message`  (
  ...
  `msg_key` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `trace_id` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '跟踪-guid',
  `tags` varchar(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '',
  `topic_id` int NOT NULL COMMENT '主题ID',
  `topic_name` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL,
  `content` varchar(999) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '内容（JSON格式）',
  `receive_url` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '定向接收目标',
  `receive_check` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '接收检查',
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = 'WATER-消息-存储表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `water_msg_message_ex_stat`  (
  ...
  INDEX `IX_log_date`(`log_date`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3748 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = 'WATER-消息-统计表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `water_msg_subscriber`  (
  ...
  `subscriber_key` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '订阅者KEY（由应用方传入）',
  `subscriber_note` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL,
  `alarm_mobile` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '报警手机号',
  `alarm_sign` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '报警签名',
  `topic_id` int NOT NULL DEFAULT 0 COMMENT '主题ID',
  `topic_name` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '主题名字',
  `receive_url` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '' COMMENT '订阅者的接收地址',
  `receive_way` int NOT NULL DEFAULT 0 COMMENT '接收方式（0,1异步等待；2异步不等待,状态设为已完成；3异步不等,状态设为处理中）',
  `receive_key` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '' COMMENT '订阅者的接收地址的访问KEY',
  ...
  INDEX `IX_topic_name`(`topic_name`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 357 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = 'WATER-消息-订阅者表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 32 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = 'WATER-消息-主题表' ROW_FORMAT = Dynamic;
