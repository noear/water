    ...
    <datagrid class="list">
        <table>
            ...
            <tr>
                ...
                <td width="70px" sort="total_num">memoryMax</td>
                <td width="60px" sort="total_num_slow1">memoryTotal</td>
                <td width="60px" sort="total_num_slow2">memoryUsed</td>
                <td width="60px" sort="total_num_slow5">threadCount</td>
