...
<toolbar class="blockquote">
    <left class="ln30">
        <h2><a href="javascript:history.back()" class="noline">公共模板</a></h2> / 设置
    </left>
    <right class="form">
        <n>ctrl + s 可快捷保存</n>
...
<detail>
    <form>
        ...
        <table>
            ...
            <tr>
                <th>编辑模板</th>
                <td><input type="text" id="edit_mode" value="${m1.edit_mode!'freemarker'}" list="edit_mode_list" autocomplete="off" required jt-alert="请选择编辑模式" />*</td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <checkbox>
                        ...
                        <label class="mar10-r"><input type="checkbox" id="is_staticize" ${m1.is_staticize?string('checked','')} /><a>静态文件</a></label>
                    </checkbox>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <th>排序</th><td><input type="text" id="rank" value="${m1.rank!}"/></td>
            </tr>
            <tr>
                <th>内容类型</th>
