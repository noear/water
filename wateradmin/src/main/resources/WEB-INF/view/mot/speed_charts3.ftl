...
<block>
    <toolbar>
        <div style="padding: 5px;overflow: hidden;">
            <@stateselector items="memoryMax,memoryTotal,memoryUsed,threadCount" clientID="chart1" onSelect="chart1_select"/>
        </div>
...
<script>
    ...
    option2 = {
        ...
        legend: {
            data:['memoryMax','memoryTotal','memoryUsed','threadCount']
        },
        grid: {
            left: '3%',
            right: '4%',
