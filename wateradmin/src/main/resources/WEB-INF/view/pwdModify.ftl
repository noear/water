...
<body>
    <detail>
        <table>
            <tr>
                <th>原密码：</th><td><input type="text" id="oldPass" placeholder="请输入原密码"></td>
            </tr>
            <tr>
                <th>新密码：</th><td><input type="text" id="newPass" placeholder="请输入新密码" ></td>
            </tr>
            <tr>
                <th>确认新密码：</th><td><input type="text" id="conNewPass" placeholder="请确认新密码"></td>
            </tr>
            <tr>
                <th></th><td><button onclick="confirm()">修改</button></td>
            </tr>
        </table>
    </detail>
</body>
