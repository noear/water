...
<head>
    ...
    <script>
        ...
        function node_onclick(tag_name,obj) {
            ...
            $(obj).addClass("sel");
            $("#table").attr('src',"/tool/certification/inner?tag_name="+tagName);
        };
    </script>
</head>
<body>
<main>
    ...
    <right class="frm">
        <iframe src="/tool/certification/inner?tag_name=${tag_name!}&_state=${_state!}" frameborder="0" id="table"></iframe>
    </right>
</main>
</body>
</html>