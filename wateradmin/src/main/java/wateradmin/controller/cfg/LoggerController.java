...
public class LoggerController extends BaseController {
    ...
    @Mapping("logger")
    public ModelAndView logger(String tag_name, int _state) throws Exception {
    ...
    public ModelAndView loggerInner(String tag_name, int _state) throws Exception {
        List<LoggerModel> list = DbWaterCfgApi.getLoggersByTag(tag_name, _state == 0, null);
    ...
    //日志配置编辑页面跳转。
    @Mapping("logger/edit")
    public ModelAndView loggerEdit(String tag_name, int logger_id) throws Exception {
    ...
    public ViewModel saveLogger(int logger_id, String tag, String logger, @Param(defaultValue = "") String source, String note, int keep_days, int is_alarm, int is_enabled) throws Exception {
    ...
    public ViewModel delLogger(int logger_id) throws SQLException {
    ...
    public ViewModel loggerDelete(int logger_id, int is_enabled) throws SQLException {
