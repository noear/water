...
public class DbWaterCfgKeyApi {
    ...
    //新增ip白名单
    public static boolean setKey(Integer key_id, String tag, String access_key, String access_secret_key, String access_secret_salt, String label, String description, String metainfo, int is_enabled) throws SQLException {
        if (key_id == null) {
            key_id = 0;
        }
