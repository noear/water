...
public class DisttimeUtils {
    ...
    public static long nextTime(int dist_count) {
        ...
        switch (dist_count){
            ...
            case 3:second  = second+2*60;break;//2分种
            case 4:second  = second+5*60;break;//5分钟
            case 5:second  = second+10*60;break;//10分钟
            case 6:second  = second+30*60;break;//30分钟
            case 7:second  = second+60*60;break;//1小时
